...
```{r tesuite_izlaznih_podataka_prije_obrade, echo=FALSE, out.width = "70%", fig.align='center', fig.cap='**Slika 3:** *Prikaz tec-suite izlaznih podataka prije obrade*'}
